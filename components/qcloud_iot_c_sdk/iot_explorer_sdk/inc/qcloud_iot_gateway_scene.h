 ...
 */
typedef struct {
    void (*gateway_scene_handles_callback)(UtilsJsonValue scene_id, UtilsJsonValue scene_name,
                                           UtilsJsonValue scene_update_time, UtilsJsonValue scene_handles,
                                           UtilsJsonValue scene_conditions, void *usr_data);
    void (*gateway_run_scene_callback)(UtilsJsonValue client_token, UtilsJsonValue scene_id, void *usr_data);
    void (*gateway_delete_scene_callback)(UtilsJsonValue scene_id, void *usr_data);
    void (*gateway_reload_scene_reply_callback)(int result_code, UtilsJsonValue status, UtilsJsonValue scene_result,
                                                void *usr_data);
