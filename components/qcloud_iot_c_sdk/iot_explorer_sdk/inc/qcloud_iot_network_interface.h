 ...
 */
typedef enum {
    TCIOT_NETWORK_TYPE_TCP = 0,
    TCIOT_NETWORK_TYPE_UDP,
    TCIOT_NETWORK_TYPE_TLS,
    TCIOT_NETWORK_TYPE_DTLS
} IotNetworkType;
...
struct IotNetwork {
    ...
    int (*write)(IotNetwork *, unsigned char *, size_t, uint32_t);
...
#ifndef ENABLE_AUTH_NO_TLS
    TCI_SSLConnectParams ssl_connect_params;
#endif
