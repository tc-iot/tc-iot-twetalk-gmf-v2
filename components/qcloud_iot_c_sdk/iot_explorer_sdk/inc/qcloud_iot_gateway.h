 ...
 */
typedef struct {
    void (*bind_unbind_reply_callback)(UtilsJsonValue sub_devices, IotBool is_bind, void *usr_data);
    void (*unbind_all_callback)(void *usr_data);
    void (*online_offline_reply_callback)(UtilsJsonValue sub_devices, IotBool is_online, void *usr_data);
    void (*search_device_callback)(IotBool is_on, void *usr_data);
    void (*describe_subdevices_reply_callback)(UtilsJsonValue sub_devices, void *usr_data);
    void (*change_subdevices_status_callback)(UtilsJsonValue sub_devices, IotBool is_bind, void *usr_data);
...
/**
 * @brief Publish subdevice bind message.
 *
 * @param[in,out] client pointer to mqtt client
 * @param[in] buf buffer to hold publish message
 * @param[in] buf_len buffer length
