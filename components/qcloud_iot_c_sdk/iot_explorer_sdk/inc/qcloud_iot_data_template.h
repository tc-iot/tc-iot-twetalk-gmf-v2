...
typedef struct {
    ...
    void (*method_get_mode_define_reply_callback)(UtilsJsonValue client_token, UtilsJsonValue property,
                                                  UtilsJsonValue event, UtilsJsonValue action, void *usr_data);
