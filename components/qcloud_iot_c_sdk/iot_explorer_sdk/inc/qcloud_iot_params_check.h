...
#ifndef IOT_HUB_DEVICE_C_SDK_INCLUDE_COMMON_QCLOUD_TCIOT_PARAMS_CHECK_H_
#define IOT_HUB_DEVICE_C_SDK_INCLUDE_COMMON_QCLOUD_TCIOT_PARAMS_CHECK_H_
...
#define STRING_PTR_PRINT_SANITY_CHECK(s) ((s) && (s)[0] != '\0' ? (s) : "null")

#define BUFF_LEN_SANITY_CHECK(num, min, err)               \
    do {                                                   \
        if ((min) > (num)) {                               \
            Log_e("Invalid argument, %d <= %d", min, num); \
            return (err);                                  \
        }                                                  \
    } while (0)
...
#endif  // IOT_HUB_DEVICE_C_SDK_INCLUDE_COMMON_QCLOUD_TCIOT_PARAMS_CHECK_H_
