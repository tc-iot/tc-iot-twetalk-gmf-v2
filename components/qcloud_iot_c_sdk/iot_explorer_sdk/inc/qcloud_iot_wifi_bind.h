...
#ifndef IOT_HUB_DEVICE_C_SDK_INCLUDE_SERVICES_EXPLORER_QCLOUD_TCIOT_WIFI_BIND_H_
#define IOT_HUB_DEVICE_C_SDK_INCLUDE_SERVICES_EXPLORER_QCLOUD_TCIOT_WIFI_BIND_H_
 ...
 */
typedef enum {
    TCIOT_WIFI_BIND_TYPE_SOFT_AP,
    TCIOT_WIFI_BIND_TYPE_SMART_CONFIG,
    TCIOT_WIFI_BIND_TYPE_AIR_KISS,
    TCIOT_WIFI_BIND_TYPE_LLSYNC_BLE,
    TCIOT_WIFI_BIND_TYPE_SIMPLE_CONFIG,
    TCIOT_WIFI_BIND_TYPE_CUSTOM_BLE,
} IotWifiBindType;
 ...
 */
typedef enum {
    TCIOT_WIFI_BIND_EVENT_MQTT_CONNECT_BEGIN,
    TCIOT_WIFI_BIND_EVENT_MQTT_CONNECT_FAIL,
    TCIOT_WIFI_BIND_EVENT_MQTT_REPORT_TOKEN_BEGIN,
    TCIOT_WIFI_BIND_EVENT_MQTT_REPORT_TOKEN_SUCCESS,
    TCIOT_WIFI_BIND_EVENT_MQTT_REPORT_TOKEN_FAIL,
} IotWifiBindEvent;
...
#endif  // IOT_HUB_DEVICE_C_SDK_INCLUDE_SERVICES_EXPLORER_QCLOUD_TCIOT_WIFI_BIND_H_
