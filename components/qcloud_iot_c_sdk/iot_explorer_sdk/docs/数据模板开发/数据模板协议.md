...
- 请求参数说明：
   ...
   |showmeta|Int|标识回复消息是否带`metadata`，缺省为0表示不返回`metadata`，主要是时间戳信息。SDK默认省略|
...
- 请求参数说明：
   ...
   |timestamp|Int|行为调用的当前时间，SDK默认省略|
