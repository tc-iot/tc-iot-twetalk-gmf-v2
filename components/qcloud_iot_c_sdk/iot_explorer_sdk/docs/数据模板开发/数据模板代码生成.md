...
- [简介](#简介)
- [数据模板创建](#数据模板创建)
- [数据模板描述文件导出](#数据模板描述文件导出)
- [数据模板模板代码生成](#数据模板模板代码生成)
...
将下载的json文件拷贝到tools目录，执行`python ./data_template_codegen.py -c xx/example_config.json -d  ../targetdir/`命令,则会根据json文件在target目录生成所定义产品的数据模板及事件的配置文件,
