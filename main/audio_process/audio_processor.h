...
typedef enum {
    AUDIO_MIXER_FG_INCREASE = 0,
    AUDIO_MIXER_BG_INCREASE = 1,
    AUDIO_MIXER_NORMAL = 2,
} audio_mixer_volume_adjust_t;
...
/**
 * @brief  Adjusts the volume of the audio mixer
 *
 * @param[in]  adjust  The volume adjustment type
 *
 * @return
 *       - ESP_OK  On success
 *       - Other   Appropriate esp_err_t error code on failure
